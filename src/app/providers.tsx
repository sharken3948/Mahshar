...
import { base, avalancheFuji, baseSepolia, sepolia, arbitrumSepolia, optimismSepolia, polygonAmoy } from 'viem/chains'
...
export const wagmiConfig = getDefaultConfig({
  ...
  chains: [arcTestnet, arcMainnet, base, avalancheFuji, baseSepolia, sepolia, arbitrumSepolia, optimismSepolia, polygonAmoy],
  ssr: true,
})
