    ...
    <main className="min-h-screen bg-[#F5F5F0]">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-36 pb-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-[#6B7280] max-w-lg mx-auto">
            Buy and sell API access with instant USDC nanopayments. AI-matched, zero integration, no subscriptions.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white border border-[#2775CA] rounded-2xl p-6 flex flex-col items-center text-center hover:border-[#00B050]/40 hover:shadow-md transition-all">
          ...
          <div className="bg-white border border-[#2775CA] rounded-2xl p-6 flex flex-col items-center text-center hover:border-[#2775CA]/40 hover:shadow-md transition-all">
      ...
      {/* How it works */}
      <section className="border-t border-[#FAFAF8] py-10 px-6 bg-white">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-[#6B7280] text-sm">Send a USDC nanopayment via x402 or use prepaid credits. No setup required.</p>
            </div>
            <div className="flex flex-col items-center gap-3">
      ...
      {/* Footer */}
      <footer className="border-t border-[#F5F5F0] py-3 px-6 text-center text-sm text-[#6B7280] bg-[#F5F5F0]">
        © {new Date().getFullYear()} Mahshar. The API economy, powered by USDC.
      </footer>

      <footer className="border-t border-[#F5F5F0] py-3 text-center">
